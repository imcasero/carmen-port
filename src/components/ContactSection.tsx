...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="min-h-screen py-16 px-4 sm:px-6 md:py-24 md:px-16 flex items-center justify-center relative overflow-hidden">
      <div
        className="absolute inset-0"
        style={{
          background: 'radial-gradient(ellipse at center, rgba(228, 241, 1, 0.16) 0%, transparent 65%)',
        }}
      ></div>
      <div
